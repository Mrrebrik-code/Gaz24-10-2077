...
public class Helicopter : MonoBehaviour {
	...
	public class EngineConfiguration
	{
		...
		[System.NonSerialized]public bool isAccelerating;
		[Range(0f,1.2f)]public float enginePower;
	...
	{
		public KeyCode engineOnOff = KeyCode.Return;
		
		public KeyCode acceleration = KeyCode.W;
		[System.NonSerialized]public bool isaccelerating;
		public KeyCode desacceleration = KeyCode.S;
		[System.NonSerialized]public bool isDesaccelerating;
	...
	{
		mainRotor.Rotate (new Vector3 (0, engineConfiguration.enginePower * Time.deltaTime * velocityConfiguration.rotorVelocity, 0));
		tailRotor.Rotate (new Vector3 (0, 0, -engineConfiguration.enginePower * Time.deltaTime * velocityConfiguration.rotorVelocity));
	}
	void Acceleration()
	{
